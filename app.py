...
# Custom modules
from CleanStockProject.data_loader import DataLoader              # Handles data retrieval
from CleanStockProject.models import ForecastingModels            # Forecasting models: ARIMA, SARIMA, etc.
from CleanStockProject.visualizations import Visualizer           # For plotting charts
from CleanStockProject.utils import calculate_metrics, format_currency  # Utility functions
...
def display_forecasts():
    ...
    from CleanStockProject.visualizations import Visualizer
